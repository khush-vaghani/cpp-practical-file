...
public:
    inventory() : Product_ID(0), Product_Name(""), Product_Price(0.0), Product_Quantity(0) {}
    inventory(int id, string name, double price, int quantity)
    {
        Product_ID = id;
        Product_Name = name;
        Product_Price = price;
    ...
    void Adding_Stock(int quantity);
    void Edit_Price(int New_Price);
